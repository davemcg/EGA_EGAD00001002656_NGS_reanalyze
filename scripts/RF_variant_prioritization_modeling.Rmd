...
set.seed(825)
columns <- c('type_indel','type_snp','num_hom_ref','num_het','num_hom_alt','aaf','is_exonic','is_coding','is_lof','is_splicing','impact_frameshift_variant','impact_inframe_deletion','impact_inframe_insertion','impact_intron_variant','impact_missense_variant','impact_splice_acceptor_variant','impact_splice_donor_variant','impact_splice_region_variant','impact_start_lost','impact_stop_gained','impact_stop_lost','impact_synonymous_variant','impact_upstream_gene_variant','aaf_1kg_all_float','aaf_esp_all','af_exac_all','pli','pnull','precessive','phylop_100way','cadd_phred')
...
xgbTreeFit <-caret::train(x=train_set %>% 
                     ...
                     # preProcess = c("scale", "center"),
                      method = "xgbTree", 
                      trControl = fitControl)
svmFit <- caret::train(x=train_set %>% 
                        dplyr::select_(.dots=columns) %>% 
                        data.frame(), 
                      y = train_set$Status, 
                      #preProcess = c("scale", "center"),
