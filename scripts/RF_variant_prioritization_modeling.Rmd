...
new_predictions <- predict.train(rfFit, test_set, type='prob') %>%
  mutate(Answers = test_set$Status, Prediction = case_when(Pathogenic > 0.2 ~ 'Pathogenic', TRUE ~ 'NotPathogenic'))
