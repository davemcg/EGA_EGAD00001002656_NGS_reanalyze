...
plot(aucroc_maker(rfFit, all_dummy %>% filter(!variant_id %in% test_set$variant_id)))
plot(aucroc_maker(caddFit, all_dummy %>% filter(!variant_id %in% test_set$variant_id)))
```
